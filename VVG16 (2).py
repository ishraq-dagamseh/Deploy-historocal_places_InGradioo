...
def load_paths():
    ...
    classes = {"Umm Qais", "Jeresh", "Petra", "Ajloun Castle", "Wadi Rum", "Roman amphitheater"}
...
def build_model(input_shape=(224, 224, 3), num_classes=6):
    """
    Build a VGG16 model with the given input shape and number of classes.
...
def evaluate_model(model, X_test, y_test):
    ...
    with open("./Models/VGG16/VGG16_eval.txt", 'w') as file:
...
def main():
    ...
    plot_history(history, save_path='./Models/VGG16/VGG16')
